...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isExistUser = yield user_models_1.User.findOne({
        email: payload.email,
    ...
    <a href="https://painthut.vercel.app/verify/${createSecret}/" target="_blank">Click here to verify your email</a>`,
        ...
        yield user_models_1.User.create(payload);
        const mailOptions = {
            from: config_1.default.my_email,
            to: payload.email,
            subject: "verify your email",
...
const LogIn = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isUserExist = yield user_models_1.User.findOne({ email: payload.email });
    if (!isUserExist) {
...
const verifyEmailAndUpdateStatus = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_models_1.User.findOneAndUpdate({ email }, { $set: { isVerified: true } });
    return result;
});
