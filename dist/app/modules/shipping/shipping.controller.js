...
const retrieveShippingAddress = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId } = req.user;
    const result = yield shipping_service_1.ShippingAddressService.retrieveShippingAddress(userId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
